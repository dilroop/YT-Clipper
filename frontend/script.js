...
async function processVideo() {
    try {
        ...
        // Handle case where error is an event or has no message
        const errorMessage = error.message || (error instanceof Event ? 'WebSocket connection failed' : 'Unknown error');
        
        // Show error in progress UI
        showProcessingError(errorMessage, 'analyzing');
    }
}
